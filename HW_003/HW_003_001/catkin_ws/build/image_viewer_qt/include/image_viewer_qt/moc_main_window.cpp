...
QT_MOC_LITERAL(1, 28, 32), // "on_HcomboBox_currentindexChanged"
QT_MOC_LITERAL(2, 61, 0), // ""
QT_MOC_LITERAL(3, 62, 5), // "index"
QT_MOC_LITERAL(4, 68, 32) // "on_WcomboBox_currentindexChanged"

    },
    "image_viewer_qt::MainWindow\0"
    "on_HcomboBox_currentindexChanged\0\0"
    "index\0on_WcomboBox_currentindexChanged"
};
...
void image_viewer_qt::MainWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_HcomboBox_currentindexChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->on_WcomboBox_currentindexChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
